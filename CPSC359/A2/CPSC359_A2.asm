...
// * Check if align statement in data section are correct and work as intended
// * Run the thing
//
...
summary:
	// Compute sum of asterisks and print it
	LDR 	addr_r, =numSquareStars 				// Get numSquareStars address
	...
	LDR 	r0, =summ1 						// Load 'summ1' string into register
	BL 	stringBitCount 						// Branch to count bits & print

	// Compute mean of square asterisks and print it
	LDR 	addr_r, =numSquareStars 				// Get numSquareStars address
	LDR 	r1, [addr_r]						// Load numSquareStars into r1
	LDR 	addr_r, =numSquares 					// Get numSquares address
	LDR 	stats_r, [addr_r]					// Load numSquares into stats_r
	DIV 	r1, r1, stats_r 					// r1 /= stats_r
	LDR 	r0, =summ2 						// Load 'summ2' string into register
	BL 	stringBitCount 						// Branch to count bits & print

	// Compute mean of rectangle asterisks and print it
	LDR 	addr_r, =numRectStars 					// Get numRectStars address
	LDR 	r1, [addr_r]						// Load numRectStars into r1
	LDR 	addr_r, =numRects 					// Get numRects address
	LDR 	stats_r, [addr_r]					// Load numRects into stats_r
	DIV 	r1, r1, stats_r 					// r1 /= stats_r
	LDR 	r0, =summ3 						// Load 'summ3' string into register
	BL 	stringBitCount 						// Branch to count bits & print

	// Compute mean of triangle asterisks and print it
	LDR 	addr_r, =numTriStars 					// Get numTriStars address
	LDR 	r1, [addr_r]						// Load numTriStars into r1
	LDR 	addr_r, =numTris 					// Get numTris address
	LDR 	stats_r, [addr_r]					// Load numTris into stats_r
	DIV 	r1, r1, stats_r 					// r1 /= stats_r
	LDR 	r0, =summ4 						// Load 'summ4' string into register
	BL 	stringBitCount 						// Branch to count bits & print

	// Return to start menu after summary has been displayed
	B 	start 							// Return to menu
...
star: 		.asciz 	"* "
starEnd: 	.asciz 	"*\n"
summ1: 		.asciz 	"Total number of stars: %d\n"
summ2: 		.asciz 	"Mean of stars used to draw squares: %f\n"
summ3: 		.asciz 	"Mean of stars used to draw rectangles: %f\n"
summ4: 		.asciz 	"Mean of stars used to draw triangles: %f\n"
