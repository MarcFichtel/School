    ...
    */
    ...
    public class T10 {
        ...
        public void Test10() {
            ...
            string[] expected = { null, "140" };            // Set up expected result
            ...
            // CHECK_TEARDOWN(190; 0; "stuff")
            int expected1 = 190;                                        // Variable holds expected result 1
            int expected2 = 0;                                          // Variable holds expected result 2
            List<string> expected3 = new List<string> { "stuff" };      // Variable holds expected result 3
